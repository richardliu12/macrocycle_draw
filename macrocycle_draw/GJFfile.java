...
public class GJFfile extends OutputFileFormat implements Immutable
{
    ...
    */
        ...
        for (List<String> line : fileContents)
            {
                ...
                Atom newAtom = new Atom(line.get(0), new Vector3D(Double.parseDouble(line.get(1)),
                                        Double.parseDouble(line.get(2)), Double.parseDouble(line.get(3))), 1);
    ...
    {
        GJFfile gjf = new GJFfile("test.gjf");
        System.out.println(gjf.molecule);
        MOL2InputFile mol2 = new MOL2InputFile(gjf.molecule);
        System.out.println(mol2);
        mol2.write("test.mol2");
    }
}
